...
def get_COCO14_modal_dicts(json_file_path, img_dir):
    ...
    dict_path = "kins_test_pred_dict.pkl"
    dict_name = "kins_test_pred_dict"
...
if __name__ == '__main__':
    for d in ["val"]:
        DatasetCatalog.register("KINS_" + d,
                                lambda d=d: get_COCO14_modal_dicts("results.json",
    ...
    dataset_dicts = get_COCO14_modal_dicts("results.json",
                                           "/Users/lizhixuan/PycharmProjects/amodal_dataset/KINS/image/testing")

    for i in range(len(dataset_dicts)):
        print("[ {} / {} ] saving KINS test pred vis".format(i, len(dataset_dicts)))
        d = dataset_dicts[i]
        img_id = d["image_id"]
        ...
        cv2.imwrite("VIS_KINS_TEST_PRED/vis_"+img_name, vis_img)
