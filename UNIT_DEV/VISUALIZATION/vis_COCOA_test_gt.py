...
def get_COCO14_modal_dicts(json_file_path, img_dir):
    ...
    dict_path = "COCOA_gt_dict.pkl"
    dict_name = "COCOA_gt_dict"
...
def register_dataset():
    for d in ["val"]:
        DatasetCatalog.register("COCOA_" + d,
                                lambda d=d: get_COCO14_modal_dicts("COCOA_val.json",
                                                                   "/Users/lizhixuan/PycharmProjects/amodal_dataset/COCOA/images/val"))
        MetadataCatalog.get("COCOA_" + d).set(thing_classes=["object"])
    print("REGISTERED!")
