...
def change_to_instance_index(origin_list):
    ...
    for i in range(len(origin_list)):
        ...
        for k in range(instance_count):
            ...
            if anno_local["isStuff"] == 0:
                instance_anno_["category_id"] = 1  # thing
            else:
                instance_anno_["category_id"] = 2  # stuff
...
def trans_to_COCO_format(annotation_file_path, coco_format_dict_save_name):
    ...
    cat_["id"] = 1
    cat_["name"] = "thing"
    cat_["supercategory"] = "thing"

    cat_s = dict()
    cat_s["id"] = 2
    cat_s["name"] = "stuff"
    cat_s["supercategory"] = "stuff"
    ...
    dataset["categories"] = []
    dataset["categories"].append(cat_)
    dataset["categories"].append(cat_s)
    dataset["info"] = info_
...
if __name__ == '__main__':
    ...
    coco_new_path = "COCOA_train_thingstuff.json"
    ...
    coco_new_path = "COCOA_val_thingstuff.json"
    trans_to_COCO_format(annotation_file, coco_new_path)
