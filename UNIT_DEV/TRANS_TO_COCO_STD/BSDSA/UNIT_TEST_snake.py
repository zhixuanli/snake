"""
test whether the tranformed json file conform to the STD coco format
"""
...
if __name__ == '__main__':
    ...
    check_if_coco_std_format("BSDSA_train")

    check_if_coco_std_format("BSDSA_test")

    check_if_coco_std_format("BSDSA_val")

    check_if_coco_std_format("BSDSA_trainval")
