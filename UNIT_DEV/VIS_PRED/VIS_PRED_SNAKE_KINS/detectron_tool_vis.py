...
from UNIT_DEV.VISUALIZATION.vis_kins_test_gt import register_dataset
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", required=False, help="output directory", default="VIS_KINS_TEST_PRED")
    parser.add_argument("--dataset", help="name of the dataset", default="KINS_val")
